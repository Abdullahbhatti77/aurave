...
const AboutPage = () => {
  const teamMembers = [
    {
      name: "Ahmar Hassan",
      role: "Founder & CEO",
      image: "Professional man with confident smile in business attire",
      description:
        "Ahmar founded Aurave with a passion for creating skincare that is both effective and kind to the skin and planet.",
    },
    // {
    //   name: "Dr. Bilal Ahmed",
    //   role: "Head of R&D",
    ...
    // },
    {
      ...
      image: "Creative professional man in a modern office setting",
      description:
        "Altaf crafts Aurave's story, connecting our brand with skincare enthusiasts worldwide.",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-stone-100 via-rose-50 to-amber-100 text-stone-800 overflow-x-hidden">
      <motion.section
        initial={{ opacity: 0, y: -50 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.8 }}
        className="relative pb-20 pt-48 md:py-32 text-center hero-bg-light"
      >
        <div className="absolute inset-0 bg-gradient-to-b from-transparent to-stone-100 opacity-50"></div>
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <motion.p
            className="text-xl md:text-2xl text-stone-700 mb-10 max-w-2xl mx-auto"
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              ...
              />
              <div className="absolute -bottom-4 -right-4 w-24 h-24 bg-amber-400 rounded-full flex items-center justify-center shadow-lg floating-animation">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => (
              <motion.div
                ...
                className="bg-white p-8 rounded-2xl shadow-xl text-center hover:shadow-2xl transition-shadow duration-300 product-card-hover"
              >
                <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-rose-500 to-amber-500 rounded-full mb-6 shadow-md">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
            {teamMembers.map((member, index) => (
              <motion.div
                ...
                className="bg-white p-6 rounded-2xl shadow-lg text-center product-card-hover"
              >
                <div className="relative w-32 h-32 mx-auto mb-6 rounded-full overflow-hidden border-4 border-amber-400 shadow-md">
                  <img
      ...
      <section className="py-16 md:py-24 bg-gradient-to-r from-rose-600 to-amber-600 text-white">
