            ...
            <div className="flex flex-col md:flex-row gap-12">
              <div className="md:w-1/2">
                ...
                <p className="text-gray-600 mb-8">
                  We're here to answer any questions you may have about our products, services, or company. Fill out the form and we'll be in touch as soon as possible.
                </p>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-start">
                      ...
                      <div className="ml-4">
                        ...
                        <p className="text-gray-600 mt-1">
                          <a href="mailto:info@aurave.com" className="text-pink-600 hover:underline">info@aurave.com</a><br />
                          <a href="mailto:support@aurave.com" className="text-pink-600 hover:underline">support@aurave.com</a>
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <div className="ml-4">
                        ...
                        <p className="text-gray-600 mt-1">
                          <a href="tel:+923001234567" className="text-pink-600 hover:underline">+92 300 123 4567</a><br />
                          <span className="text-gray-500">Monday-Friday: 9am to 5pm</span>
                        </p>
                      </div>
                    </div>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-3xl mx-auto space-y-6">
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <p className="text-gray-600">
                  Domestic orders typically arrive within 3-5 business days. International shipping times vary by location, but generally take 7-14 business days.
                </p>
              </div>
              
              <div className="bg-white p-6 rounded-lg shadow-md">
                <h3 className="text-xl font-semibold text-gray-800 mb-3">Are your products cruelty-free?</h3>
                <p className="text-gray-600">
                  Yes, all Aurave products are 100% cruelty-free. We never test on animals and we don't work with suppliers who do.
                </p>
              </div>
              
              <div className="bg-white p-6 rounded-lg shadow-md">
                <h3 className="text-xl font-semibold text-gray-800 mb-3">Do you offer samples?</h3>
                <p className="text-gray-600">
