    ...
    <section className="py-16 bg-gray-900">
      <div className="container mx-auto px-4">
        ...
        <p className="text-gray-400 text-center mb-12">
          Handpicked favorites loved by our community for their transformative
          results.
        </p>
        ...
        <div className="text-center mt-12">
          <Link
            href="/products"
            className="inline-flex items-center text-amber-400 hover:text-amber-300 border border-amber-400 hover:border-amber-300 px-6 py-3 rounded-full transition-colors cursor-pointer"
          >
