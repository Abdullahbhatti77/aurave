...
const CheckoutPage = () => {
  ...
  // Simplified ContactInformationForm component
  ...
  // Simplified ShippingAddressForm component
  ...
  // Simplified PaymentMethodSelection component
  ...
  // Simplified OrderSummary component
  const OrderSummary = ({
    items,
    totalPrice,
    tax,
  ...
  // Simplified OrderConfirmation component
    ...
    >
      ...
      <div className="bg-pink-50 rounded-lg p-6 mb-8">
        <p className="text-sm text-gray-700">
          ...
          details. For Cash on Delivery orders, please have the exact amount
          ready.
        </p>
      </div>
  ...
  // Simplified EmptyCartMessage component
